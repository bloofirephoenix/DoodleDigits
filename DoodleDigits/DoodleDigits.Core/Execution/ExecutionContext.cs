...
public class ExecutionContext {
    protected class ExecutionContextData {
        ...
        public ExecutionContextData(IEnumerable<Constant> constants, AngleUnit angleUnit) {
    ...
    public AngleUnit AngleUnit => data.AngleUnit;

    public ExecutionContext(IEnumerable<Constant> constants, AngleUnit angleUnit) {
        data = new ExecutionContextData(constants, angleUnit);
    }
