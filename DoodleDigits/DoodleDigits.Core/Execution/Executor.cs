...
public class Executor {
    ...
    public Executor(CalculatorSettings calculatorSettings) {
        results = new List<Result>();
        this.functions = new Dictionary<string, FunctionData>();
        foreach (FunctionData functionData in calculatorSettings.Functions) {
            foreach (string name in functionData.Names) {
                this.functions.Add(name, functionData);
            }
        }
        context = new ExecutionContext(calculatorSettings.Constants, calculatorSettings.AngleUnit);
    }
