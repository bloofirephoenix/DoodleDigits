...
public partial class MainWindow : MetroWindow {
    ...
    public MainWindow() {
        ...
        settings.Load();
        PresentationProperties = new(settings);
    ...
    private Task<CalculationResult> RunExecution(string input) {
        var task = Task.Run(() => {
            Calculator calculator = new Calculator(new CalculatorSettings() { });
    ...
    private async void ToggleAlwaysOnTop(object sender, RoutedEventArgs e) {
    ...
    private void SettingsClickEvent(object sender, RoutedEventArgs e) {
        SettingsWindow settingsWindow = new SettingsWindow(settings, PresentationProperties);
        settingsWindow.Show();
    }
